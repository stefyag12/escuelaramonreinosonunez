...
<div class="regresar-container">
    ...
    <input type="submit" name="regresar" value="Regresar"  onclick="location.href='menu1.html';">
</div>
 <br>
    ...
    function imprimir_datos($result) {
        echo "<table>";
        echo "<tr><th>Cedula</th><th>Nombre Estudiante</th><th>Edad</th><th>Nombre Representante</th><th>Telefono</th><th>Email</th><th>Grado</th><th>Fecha Nacimiento</th><th>Sexo</th><th>Direccion</th><th>Acta de Nacimiento</th><th>Copia de cedula del representante</th><th>Cardiovascular</th><th>Carton de Vacunación</th><th>Certificado del último grado aprobado</th><th>Foto del estudiante</th><th>Observación</th></tr>";
