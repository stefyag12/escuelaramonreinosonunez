...
<body>
<br><br>
<h2 style="color: white;font-size: 36px;">Docentes Activos</h2>
<br><br><br><br>
<a href="menu3.html">Volver a menú anterior </a>
        ...
        if (!empty($grado)) {
            ...
            if ($result->num_rows > 0) {
                ...
                while ($fila = $result->fetch_assoc()) {
                    ...
                    echo "<td><a href='editar_docente.php?cedula=" . $fila['cedula'] . "'>Editar</a></td>";
                    echo "</tr>";
                }
            } else {
